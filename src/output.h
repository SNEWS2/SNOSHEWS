...
void Output_Pvsr(bool firsttime,std::ofstream &fPvsr,double r,std::vector<std::vector<std::array<double,NY> > > &Y,std::vector<std::vector<std::array<MATRIX<std::complex<double>,NF,NF>,NF> > > &C0,std::vector<std::vector<std::array<std::array<double,NF>,NF> > > A0,std::vector<std::vector<MATRIX<std::complex<double>,NF,NF> > > &Scumulative);
...
void Output_Hvsr(bool firsttime,std::ofstream &fHvsr,double r,std::vector<std::vector<std::array<double,NY> > > &Y,std::vector<std::vector<std::array<MATRIX<std::complex<double>,NF,NF>,NF> > > &C0,std::vector<std::vector<std::array<std::array<double,NF>,NF> > > A0,std::vector<std::vector<MATRIX<std::complex<double>,NF,NF> > > &Scumulative);
